...
# specify constraints through a weighted list of bonds.
liste = []
liste += [[116, 108, 1.0]]  # O1-C
liste += [[108, 94, -1.0]]  # C-O2

# specify initial value of the constraint any string will cause the constraint to keep the current value. otherwise
# the constraint will be set to the desired value such as 0.1 etc.'
initial_value = ' '

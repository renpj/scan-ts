...
for diff in xx:
    ...
    # specify initial value of the constraint any string will cause the constraint to keep the current value.
    # otherwise the constraint will be set to the desired value such as 0.1 etc.'
    initial_value = diff
